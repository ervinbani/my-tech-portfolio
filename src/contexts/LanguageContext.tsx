...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.description":
      "I'm a passionate software engineer with 5+ years of experience building web applications. I specialize in React, TypeScript, and modern web technologies. When I'm not coding, you'll find me exploring new technologies or contributing to open-source projects.",
  ...
  it: {
    ...
    "hero.title": "Software Engineer",
    "hero.subtitle":
      "Creo esperienze digitali eccezionali con codice pulito e soluzioni creative.",
    ...
    "about.description":
      "Sono un software engineer appassionato con oltre 5 anni di esperienza nella creazione di applicazioni web. Mi specializzo in React, TypeScript e tecnologie web moderne. Quando non sto programmando, mi troverete ad esplorare nuove tecnologie o a contribuire a progetti open-source.",
    ...
    "contact.subtitle":
      "Hai un progetto in mente? Creiamo qualcosa di straordinario.",
